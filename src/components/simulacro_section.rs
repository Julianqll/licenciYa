                ...
                .map(|(name, description, color, param)| view! 
                    {
                        ...
                        <a href=format!("{}/{}", env::APP_PUBLIC_URL, param) class=format!("rounded-md px-3.5 py-2.5 my-5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 {}", color)>
                            {name}
                        </a>
